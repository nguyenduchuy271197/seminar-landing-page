  ...
  const features = [
    {
      ...
      title: "Nhanh, gọn, xúc tích",
      desc: "Truyền tải đúng trọng tâm, kiến thức được chọn lọc kĩ càng và đơn giản hóa từ hàng ngàn giờ nghiên cứu và đầu tư",
    },
    {
      icon: (
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: "Bộ lọc chống “ngợp”",
      desc: "Cách phân bổ danh mục như thế nào thì hợp lý để đạt hiệu quả tối đa với khẩu vị rủi ro của bạn.",
    },
    {
      icon: (
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      desc: "Bạn sẽ được trao đổi với diễn giả về kinh nghiệm đầu tư, giúp các bạn ứng dụng hiệu quả vào thực tế",
    },
    {
      icon: (
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      desc: "Vừa học vừa làm, áp dụng ngay kiến thức vừa học, nâng cao kỹ năng thực chiến sau buổi học.",
    },
  ];
    ...
    <section className="bg-neutral-100" id="benefits">
      <div className="container">
        <div className="space-y-12 py-20">
          <div className="h2">
            <h2 className="max-w-[813px]">
              Cách học khác biệt dẫn tới{" "}
              <HighlightWord>Thành Công</HighlightWord>
            </h2>
          </div>
