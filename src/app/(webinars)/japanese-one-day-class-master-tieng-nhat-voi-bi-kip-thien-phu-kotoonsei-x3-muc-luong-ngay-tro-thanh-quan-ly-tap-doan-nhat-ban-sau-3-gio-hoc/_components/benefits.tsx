  ...
  const features = [
    {
      ...
      title: "tái tạo giọng nói theo tư duy chuẩn người nhật bản",
      desc: "Tái tạo âm thanh tự nhiên nhất và phù hợp với văn hóa người Nhật.",
    },
    {
      icon: (
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: "lĩnh hội kinh nghệm được tiền bối đúc kết",
      desc: "Cách đối mặt với khó khăn, làm sao để thích ứng và tận dụng cơ hội từ sự thay đổi.",
    },
    {
      icon: (
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      title: "tìm nguồn cảm hứng động lực để phát triển sâu",
      desc: "Trở thành một người nước ngoài có thể sử dụng tiếng Nhật tự nhiên và lưu loát.",
    },
  ];
